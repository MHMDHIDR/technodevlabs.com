...
const MenuBar = ({ editor }: { editor: any }) => {
  ...
  return (
    <div className='flex flex-wrap gap-2 p-2 bg-gray-100 dark:bg-gray-700 rounded-t-md'>
      ...
      <Button onClick={addImage} className='px-2 py-1 text-sm bg-white dark:bg-gray-700'>
        Add Image
      </Button>
    </div>
  )
    ...
    <section className='max-w-4xl p-6 mx-auto'>
      ...
      <form onSubmit={submitPost} className='space-y-6'>
        ...
        <LabelInputContainer>
          ...
          <div className='block w-full mt-1 overflow-hidden border border-gray-300 rounded-md shadow-sm'>
            <MenuBar editor={editor} />
            <EditorContent editor={editor} className='min-h-52 p-1.5' />
          </div>
        </LabelInputContainer>
