  ...
  return (
    <Layout className={`p-4 py-20`}>
      <h1 className='relative z-20 py-6 mx-auto mt-6 text-4xl font-semibold text-center text-transparent md:text-4xl lg:text-6xl max-w-7xl bg-clip-text bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white'>
        TERMS AND CONDITIONS <br /> of <Cover>TechnoDevLabs</Cover>
      </h1>
      ...
      <section className='py-20 leading-[3rem] text-justify container'>
        ...
        <p>
          ...
          website located at <b>https://www.technodevlabs.com</b> (together or
          individually “Service”) operated by <b>TechnoDevLabs</b>.
        </p>
        <p>
          Our <PrivacyPageLink /> also governs your use of our Service and explains how we
        ...
        <p>
          ...
          use the Service, but please let us know by emailing at <EmailUs /> so we can try
        ...
        <p>
          ...
          unsubscribe link or by emailing at <EmailUs />
        </p>
        <p>
          3. <b>Purchases</b>
        </p>
        ...
        <p>
          ...
          applicable rules as well as our <PrivacyPageLink />. If the rules for a
        ...
        <p>
          We issue refunds for Contracts within <b>0 days</b> of the original purchase of
          the Contract.
        </p>
        <p>
          6. <b>Content</b>
        ...
        <p>
          Content found on or through this Service are the property of TechnoDevLabs or
        ...
        <p>
          ...
          and functionality are and will remain the exclusive property of TechnoDevLabs
          ...
          product or service without the prior written consent of TechnoDevLabs.
        </p>
        <p>
        ...
        <p>
          ...
          infringement, please submit your claim via email to <EmailUs />, with the
        ...
        <p>
          You may provide us either directly at <EmailUs /> or via third party sites and
        ...
        <p>
          ...
          owned or controlled by TechnoDevLabs.
        </p>
        <p>
          TechnoDevLabs has no control over, and assumes no responsibility for the
          content, <PrivacyPageLink />, or practices of any third party web sites or
          services. We do not warrant the offerings of any of these entities/individuals
          or their websites.
        </p>
        <p>
          For example, the outlined{' '}
          <a href='https://policymaker.io/terms-and-conditions/'>Terms of Use</a> have
          been created using <a href='https://policymaker.io/'>PolicyMaker.io</a>, a free
          web application for generating high-quality legal documents. PolicyMaker&apos;s{' '}
        ...
        <p>
          WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND <PrivacyPageLink /> OF
        ...
        <p>
          ...
          Qatar, which governing law applies to agreement without regard to its conflict
          of law provisions.
        </p>
        <p>
