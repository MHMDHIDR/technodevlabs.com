      ...
      >
        {pathname === '/' ? (
          ...
          <motion.p className='container max-w-6xl py-3 text-xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-b from-neutral-50 to-neutral-400'>
            ...
            profession—it&apos;s an art form. Our team combines technical expertise with creativity
            to deliver innovative digital solutions that empower businesses to thrive in a
            competitive landscape. We approach programming with a playful spirit, transforming
            complex challenges into engaging experiences that resonate with users.
