    ...
    <Layout className={`p-4 py-20`}>
      ...
      <section className='py-20 leading-[3rem] text-justify container'>
        ...
        <p>
          ...
          (“Company”, “we”, “our”, “us”)! We are committed to protecting your privacy and ensuring
        ...
        <p>
          ...
          when you visit our website located at <strong>https://www.technodevlabs.com</strong>{' '}
        ...
        <p>
          ...
          please discontinue using our Service. This Privacy Policy applies to all visitors, users,
        ...
        <p>
          ...
          with certain personally identifiable information, such as your name, email address, and
          payment information.
        </p>
        <p>
          - <strong>Usage Data</strong>: We may also collect information on how the Service is
          accessed and used, such as your IP address, browser type, and browsing behavior.
        </p>
        ...
        <ul>
          ...
          <li>
            To provide you with news, special offers, and general information unless you have opted
        ...
        <p>
          ...
          purposes outlined in this Privacy Policy. We will also retain usage data for internal
          analysis purposes.
        </p>
        ...
        <p>
          ...
          Cookies are files with a small amount of data that may include an anonymous unique
          identifier.
        </p>
        <p>
        ...
        <p>
          You have the right to access, update, or delete the information we have on you. If you
          wish to be informed about what personal information we hold about you or if you want it to
        ...
        <p>
          If you have any questions about this Privacy Policy, please contact us at <EmailUs />.
        </p>
      </section>
    </Layout>
  )
