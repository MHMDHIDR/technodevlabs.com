  ...
  return (
    <Layout className={`p-4 py-20`}>
      <h1 className='relative z-20 py-6 mx-auto mt-6 text-4xl font-semibold text-center text-transparent max-w-7xl bg-clip-text bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white'>
        <Cover>Terms and Conditions</Cover>
      </h1>
      ...
      <section className='py-20 leading-[3rem] text-justify container'>
        ...
        <p>
          Welcome to <b>TechnoDevLabs</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website
          located at <b>https://www.technodevlabs.com</b> (together or individually “Service”)
          operated by <b>TechnoDevLabs</b>.
        </p>
        <p>
          Our <PrivacyPageLink /> also governs your use of our Service and explains how we collect,
          safeguard and disclose information that results from your use of our web pages.
        </p>
        <p>
          Your agreement with us includes these Terms and our <PrivacyPageLink />
          (“Agreements”). You acknowledge that you have read and understood Agreements, and agree to
          be bound of them.
        </p>
        <p>
          If you do not agree with (or cannot comply with) Agreements, then you may not use the
          Service, but please let us know by emailing at <EmailUs /> so we can try to find a
        ...
        <p>
          ...
          provide the information to these third parties subject to our <PrivacyPageLink />.
        </p>
        <p>
        ...
        <p>
          ...
          <PrivacyPageLink />. If the rules for a Promotion conflict with these Terms of Service,
        ...
        <p>
          We issue refunds for Contracts within <b>0 days</b> of the original purchase of the
          Contract.
        </p>
        <p>
          6. <b>Content</b>
        ...
        <p>
          Content found on or through this Service are the property of TechnoDevLabs or used with
        ...
        <p>
          ...
          or interfere with any other party&apos;s use of Service, including their ability to engage
        ...
        <p>
          0.6. Attempt to gain unauthorized access to, interfere with, damage, or disrupt any parts
        ...
        <p>
          ...
          functionality are and will remain the exclusive property of TechnoDevLabs and its
          ...
          without the prior written consent of TechnoDevLabs.
        </p>
        <p>
          11. <b>Copyright Policy</b>
        </p>
        <p>
        ...
        <p>
          ...
          submit your claim via email to <EmailUs />, with the subject line: “Copyright
        ...
        <p>
          You can contact our Copyright Agent via email at <EmailUs />.
        </p>
        <p>
          13. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at <EmailUs /> or via third party sites and tools with
          information and feedback concerning errors, suggestions for improvements, ideas, problems,
          complaints, and other matters related to our Service (“Feedback”). You acknowledge and
          agree that: (i) you shall not retain, acquire or assert any intellectual property right or
          other right, title or interest in or to the Feedback; (ii) Company may have development
          ...
          obligation of confidentiality with respect to the Feedback. In the event the transfer of
        ...
        <p>
          14. <b>Links To Other Web Sites</b>
        </p>
        <p>
          Our Service may contain links to third party web sites or services that are not owned or
          controlled by TechnoDevLabs.
        </p>
        <p>
          TechnoDevLabs has no control over, and assumes no responsibility for the content,{' '}
          <PrivacyPageLink />, or practices of any third party web sites or services. We do not
          warrant the offerings of any of these entities/individuals or their websites.
        </p>
        <p>
          For example, the outlined{' '}
          <a href='https://policymaker.io/terms-and-conditions/'>Terms of Use</a> have been created
          using <a href='https://policymaker.io/'>PolicyMaker.io</a>, a free web application for
          generating high-quality legal documents. PolicyMaker&apos;s{' '}
          <a href='https://policymaker.io/terms-and-conditions/'>Terms and Conditions generator</a>{' '}
          is an easy-to-use free tool for creating an excellent standard Terms of Service template
        ...
        <p>
          WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND <PrivacyPageLink /> OF ANY THIRD
          PARTY WEB SITES OR SERVICES THAT YOU VISIT.
        </p>
        <p>
          15. <b>Disclaimer Of Warranty</b>
        </p>
        <p>
        ...
        <p>
          16. <b>Limitation Of Liability</b>
        </p>
        <p>
          ...
          DAMAGE. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY,
          IT WILL BE LIMITED TO THE AMOUNT PAID FOR THE PRODUCTS AND/OR SERVICES, AND UNDER NO
          CIRCUMSTANCES WILL THERE BE CONSEQUENTIAL OR PUNITIVE DAMAGES. SOME STATES DO NOT ALLOW
          THE EXCLUSION OR LIMITATION OF PUNITIVE, INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE PRIOR
        ...
        <p>
          18. <b>Governing Law</b>
        </p>
        <p>
          These Terms shall be governed and construed in accordance with the laws of Qatar, which
        ...
        <p>
          21. <b>Waiver And Severability</b>
        </p>
        <p>
        ...
        <p>
          Please send your feedback, comments, requests for technical support by email: <EmailUs />
        </p>
      </section>
    </Layout>
  )
...
function PrivacyPageLink() {
  return (
    <Link href='/privacy' className='hover:underline text-neutral-800 dark:text-neutral-200'>
