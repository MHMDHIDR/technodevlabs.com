...
import { Paper, Book, Chat } from '@/app/components/icons'
      ...
      <div className='container flex items-center justify-center min-h-screen px-6 py-12 mx-auto'>
        <div className='w-full '>
          ...
          <div className='grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3'>
            <Link
              href='/portfolio'
              className='p-6 rounded-lg bg-blue-50 dark:bg-gray-800 group'
            >
              ...
              <p className='mt-2 text-gray-500 dark:text-gray-400 '>
                Dive into our portfolio to see our latest projects.
              </p>
