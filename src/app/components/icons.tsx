 ...
 * @see https://simpleicons.org/?q=twitter - Icon source
 */
 ...
 * @see https://simpleicons.org/?q=github - Icon source
 */
 ...
 */
export const Success = ({ className }: { className?: string }): JSX.Element => {
  return (
    <svg
      viewBox='0 0 87 87'
      version='1.1'
 ...
 * @returns {JSX.Element} - Success Icon
 */
export const Error = ({ className }: { className?: string }): JSX.Element => {
  return (
    <svg
      viewBox='0 0 87 87'
      version='1.1'
