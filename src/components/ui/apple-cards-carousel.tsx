...
export const Carousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className='relative w-full rtl:ltr'>
        <div
        ...
        >
          ...
          <div className={'flex flex-row gap-4 justify-start pl-4 mx-auto max-w-7xl'}>
...
export const Card = ({
  ...
  const [hovering, setHovering] = useState(false) // Manage hover state
  ...
  return (
    <>
        ...
        {open && (
          <div className='overflow-auto fixed inset-0 z-50 h-screen'>
            ...
            <motion.div
              ...
              className='max-w-5xl mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] h-fit z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative'
            >
              <button
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className='rounded-3xl bg-gradient-to-r from-[#1D2235] to-[#121318] h-80 w-56 md:h-[40rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10'
      >
