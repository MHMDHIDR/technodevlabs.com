...
// BlurImage component moved here to avoid reference issues
    ...
    <>
      ...
      <Lens hovering={hovering} setHovering={setHovering}>
        <motion.button
          layoutId={layout ? `card-${card.title}` : undefined}
          onClick={handleOpen}
          className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-80 w-56 md:h-[40rem] md:w-96 overflow-hidden relative z-10"
        >
          <BlurImage
            src={card.src}
            alt={card.title}
          ...
          {/* Title and Category at Top Left */}
