...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn('block relative md:hidden', className)}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId='nav'
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'hidden gap-3 items-center p-2 px-4 mx-auto bg-gray-100 rounded-2xl md:flex dark:bg-neutral-900',
        className
      )}
    >
      {items.map(item => (
  ...
  return (
    <div className='flex relative justify-center items-center'>
      <motion.div
        ...
        className='flex justify-center items-center bg-gray-200 rounded-full aspect-square dark:bg-neutral-800'
      >
        {icon}
      </motion.div>
      <AnimatePresence>
