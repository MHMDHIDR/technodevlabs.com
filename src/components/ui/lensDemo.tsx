    ...
    <div>
      <div className='w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8 my-10'>
        ...
        <div className='relative z-10'>
          ...
          >
            <h2 className='text-2xl font-bold text-left text-white'>Apple Vision Pro</h2>
...
const Beams = () => (
  <svg
    ...
    className='absolute top-0 left-1/2 w-full -translate-x-1/2 pointer-events-none'
  >
...
const Rays = ({ className }: { className?: string }) => (
  <svg
    ...
    fill='none'
    xmlns='http://www.w3.org/2000/svg'
    className={cn('absolute top-0 left-0 pointer-events-none z-[1]', className)}
  >
