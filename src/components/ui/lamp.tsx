  ...
  return (
    ...
    >
      <div className='relative z-0 flex items-center justify-center flex-1 w-full mt-24 scale-y-125 isolate'>
        ...
        <div className='absolute w-full h-48 top-1/2 translate-y-12 scale-x-150 bg-slate-950 blur-2xl'></div>
        <div className='absolute z-50 w-full h-48 bg-transparent top-1/2 opacity-10 backdrop-blur-md'></div>
        <div className='absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-purple-200 opacity-50 blur-3xl'></div>
        <motion.div
          initial={{ width: '8rem' }}
